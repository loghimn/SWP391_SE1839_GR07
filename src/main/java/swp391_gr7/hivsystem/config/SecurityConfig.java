        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                      ...
                      //  .requestMatchers(HttpMethod.GET, "/api/oauth2/loginSuccess").permitAll()
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/reminder/create").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/blogs/create").permitAll()
                        .requestMatchers(HttpMethod.PUT, "/api/blogs/update/{id}").permitAll()
                        .requestMatchers(HttpMethod.DELETE, "/api/blogs/delete/{id}").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/materials/create").permitAll()
                        .requestMatchers(HttpMethod.PUT, "/api/materials/update/{id}").permitAll()
                        .requestMatchers(HttpMethod.DELETE, "/api/materials/delete/{id}").permitAll()
