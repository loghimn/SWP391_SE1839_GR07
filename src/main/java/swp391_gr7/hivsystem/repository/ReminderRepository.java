...
public interface ReminderRepository extends JpaRepository<Reminders, Integer> {
    ...
    List<Reminders> findReminderStatusTrueAndReminderTimeBefore(@Param("reminderTime") LocalDateTime reminderTime);
    ...
    List<Reminders> findRemindersByStaffs(Staffs staffs);
}
