...
//        doctors.setDepartment("Department 1");
        ...
        //Create ScheduleAdd commentMore actions
        Schedules schedules1 = null;
        for (int i = 0; i < 25; i++) {
            schedules1 = new Schedules();
            schedules1.setManagers(manager);
            schedules1.setDoctors(doctors1);
            schedules1.setNotes("Ngày đi làm");
            schedules1.setWorkDate(LocalDate.of(2025, 8, 1 + i));
            schedulesRepository.save(schedules1);
        }
        for (int i = 0; i < 25; i++) {
            schedules1 = new Schedules();
            schedules1.setManagers(manager);
            schedules1.setDoctors(doctors1);
            schedules1.setNotes("Ngày đi làm");
            schedules1.setWorkDate(LocalDate.of(2025, 9, 1 + i));
            schedulesRepository.save(schedules1);
        }
        for (int i = 0; i < 25; i++) {
            schedules1 = new Schedules();
            ...
            schedules1.setDoctors(doctors1);
            schedules1.setNotes("Ngày đi làm");
            schedules1.setWorkDate(LocalDate.of(2025, 10, 1 + i));
            schedulesRepository.save(schedules1);
        }
        ...
        for (int i = 0; i < 25; i++) {
            ...
            schedules2.setManagers(manager);
            schedules2.setDoctors(doctors2);
            schedules2.setNotes("Ngày đi làm");
            schedules2.setWorkDate(LocalDate.of(2025, 8, 1 + i));
            schedulesRepository.save(schedules2);
        }
        for (int i = 0; i < 25; i++) {
            schedules2 = new Schedules();
            schedules2.setManagers(manager);
            schedules2.setDoctors(doctors2);
            schedules2.setNotes("Ngày đi làm");
            schedules2.setWorkDate(LocalDate.of(2025, 9, 1 + i));
            schedulesRepository.save(schedules2);
        }
        for (int i = 0; i < 25; i++) {
            schedules2 = new Schedules();
            ...
            schedules2.setDoctors(doctors2);
            schedules2.setNotes("Ngày đi làm");
            schedules2.setWorkDate(LocalDate.of(2025, 10, 1 + i));
            schedulesRepository.save(schedules2);
        }

        //Create ScheduleAdd commentMore actions
        Schedules schedules3 = null;
        for (int i = 0; i < 25; i++) {
            schedules3 = new Schedules();
            schedules3.setManagers(manager);
            schedules3.setDoctors(doctors3);
            schedules3.setNotes("Ngày đi làm");
            schedules3.setWorkDate(LocalDate.of(2025, 8, 1 + i));
            schedulesRepository.save(schedules3);
        }
        for (int i = 0; i < 25; i++) {
            schedules3 = new Schedules();
            schedules3.setManagers(manager);
            schedules3.setDoctors(doctors3);
            schedules3.setNotes("Ngày đi làm");
            schedules3.setWorkDate(LocalDate.of(2025, 9, 1 + i));
            schedulesRepository.save(schedules3);
        }
        for (int i = 0; i < 25; i++) {
            schedules3 = new Schedules();
            ...
            schedules3.setDoctors(doctors3);
            schedules3.setNotes("Ngày đi làm");
            schedules3.setWorkDate(LocalDate.of(2025, 10, 1 + i));
            schedulesRepository.save(schedules3);
        }
        //Create ScheduleAdd commentMore actions
        Schedules schedules4 = null;
        for (int i = 0; i < 25; i++) {
            schedules4 = new Schedules();
            schedules4.setManagers(manager);
            schedules4.setDoctors(doctors4);
            schedules4.setNotes("Ngày đi làm");
            schedules4.setWorkDate(LocalDate.of(2025, 8, 1 + i));
            schedulesRepository.save(schedules4);
        }
        for (int i = 0; i < 25; i++) {
            schedules4 = new Schedules();
            schedules4.setManagers(manager);
            schedules4.setDoctors(doctors4);
            schedules4.setNotes("Ngày đi làm");
            schedules4.setWorkDate(LocalDate.of(2025, 9, 1 + i));
            schedulesRepository.save(schedules4);
        }
        for (int i = 0; i < 25; i++) {
            schedules4 = new Schedules();
            ...
            schedules4.setDoctors(doctors4);
            schedules4.setNotes("Ngày đi làm");
            schedules4.setWorkDate(LocalDate.of(2025, 10, 1 + i));
            schedulesRepository.save(schedules4);
        }
//
//
